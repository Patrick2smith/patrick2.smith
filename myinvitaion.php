      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Events<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">Create Event</a></li>
		   ...
		   <li><a href="myinvitation.php"> My Invitations</a></li>
        </ul>
...
<center><h1>My Invitations </center>
...
// sending query
$result = mysql_query("SELECT * FROM {$table} where invitee='$user_check'");
if (!$result) {
...
{
	echo "<br>";
	echo '<h1><a href="editevent.php?invite_id='.$row['invite_id'].'">'.$row["event_name"].'</a>';
