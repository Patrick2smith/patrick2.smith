...
<div class="dropdown">
  ...
  <div class="dropdown">
    <button class="btn btn-primary dropdown-toggle" class="glyphicon glyphicon-user" type="button" id="menu1" data-toggle="dropdown">Invite Options
    <span class="caret"></span></button>
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
      <li role="presentation"><a role="menuitem" tabindex="-1" href="invitation.php">Send Invitation</a></li>
...
{
	echo "<br>";
	echo '<h1><a href="editevent.php?event_id='.$row['event_id'].'">'.$row["event_name"].'</a>';
