...
$sql="INSERT INTO $tbl_name(event_id,event_name,event_type,event_date,event_address,event_city,event_state,event_zip,event_time,event_price,event_private,smoking_permitted,drinks_provided,food_provided,music_type,event_organizer)
VALUES('$id','$name','$type','$date','$add','$city','$state','$zip','$time','$price','$private','$smoke','$drink','$food','$music','$org')";
