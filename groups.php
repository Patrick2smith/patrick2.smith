...
<center><h1>Create a Group</center>
  ...
  <div data-role="main" class="ui-content">
    <form method="post" action="group_create.php">
      ...
      <input type="hidden" name="group_id" id="group_id" value="" data-clear-btn="true" value="">
	
      <br><label for="group_name">Group Name:</label>
      <input type="text" name="group_name" id="group_name" data-clear-btn="true" placeholder="Enter a Group Name...">
     
      <input type="hidden" name="group_creator" id="group_creator"  value="<?php echo $user_check?>" data-clear-btn="true" >
