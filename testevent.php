...
<center><h1>Edit My Events</center>
...
<div data-role="page">
  ...
  <div data-role="main" class="ui-content">
    <form method="post" action="">
	 ...
	 <input type="hidden" name="event_id" id="event_id" value="" data-clear-btn="true" placeholder="Enter Event Name...">
      
	  <br><label for="event_name">Event Name:</label>
      <input type="text" name="event_name" id="event_name" data-clear-btn="true" placeholder="Enter Event Name...">
        
		<br><label for="event_date">Event Date:</label>
      <input type="date" name="event_date" id="event_date" data-clear-btn="true" placeholder="Enter the Date...">
	  
	   <br><label for="event_time">Event Time:</label>
      <input type="text" name="event_time" id="event_time" data-clear-btn="true">
	  
	  <br><label for="event_type">Event type:</label>
      <input type="text" name="event_type" id="event_type" data-clear-btn="true" placeholder="Pool Party, House Party i.e...">
       
	   <br><label for="event_address">Event Address:</label>
      <input type="text" name="event_address" id="event_address" data-clear-btn="true" placeholder="Enter Event Address...">
