...
<a href="https://twitter.com/FamuNewBeginnings" class="twitter-follow-button" data-show-count="false">Follow @Hotspot</a>
...
<div data-role="page">
  ...
  <div data-role="main" class="ui-content">
    <form method="post" action="eventcreate.php">
	  ...
	  <input type="hidden" name="event_id" value="1234568" id="event_id" data-clear-btn="true" placeholder="...">
      
	  <br><label for="event_name">Event Name:</label>
      <input type="text" name="event_name" id="event_name" data-clear-btn="true" value="<?php echo $event_name?>">
        
		<br><label for="event_date">Event Date:</label>
      <input type="date" name="event_date" id="event_date" data-clear-btn="true" value="<?php echo $event_date?>">
	  
	   <br><label for="event_time">Event Time:</label>
      <input type="text" name="event_time" id="event_time" data-clear-btn="true" value="<?php echo $event_time?>">
	  
	  <br><label for="event_type">Event type:</label>
      <input type="text" name="event_type" id="event_type" data-clear-btn="true" value="<?php echo $event_type?>">
       
	   <br><label for="event_address">Event Address:</label>
      <input type="text" name="event_address" id="event_address" data-clear-btn="true" value="<?php echo $event_address?>">
       
	      <br><label for="event_city">Event City:</label>
      <input type="text" name="event_city" id="event_city" data-clear-btn="true">
       
	   <br><label for="event_state">Event State:</label>
      <input type="text" name="event_state" id="event_state" data-clear-btn="true">
       
	   <br><label for="event_zip">Event Zip Code:</label>
      <input type="text" name="event_zip" id="event_zip" data-clear-btn="true">
    
<br><label for="event_price">Event price:</label>
      <input type="text" name="event_price" id="event_price" data-clear-btn="true">
      ...
      <input type="text" name="music_type" id="music_type" data-clear-btn="true">
		

     <input type="hidden" name="event_organizer" value="<?php echo $user_check?>" id="event_organizer" data-clear-btn="true" placeholder="...">
