...
<div class="dropdown">
    <button class="btn btn-danger dropdown-toggle" class="glyphicon glyphicon-user" type="button" id="menu1" data-toggle="dropdown">Invite Options
    <span class="caret"></span></button>
    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
      <li role="presentation"><a role="menuitem" tabindex="-1" href="invite.php">Send Invitation</a></li>
      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">My Invitation</a></li>
...
<div data-role="page">
  ...
  <div data-role="main" class="ui-content">
    <form method="post" action=<?php echo '"myinvite.php?invite_id='. $_GET['event_id']. '"'; ?>>
      <div class="ui-field-contain">
      
	 <!--input type="hidden" name="invite_id" id="invite_id" value="<?php //$_GET['event_id']; ?>" data-clear-btn="true" placeholder="Enter Event Name..."-->
      
	 <br><label for="invitee">Enter Username to Invite:</label>
      <input type="text" name="invitee" id="invitee" value="<?php echo $invitee?>" data-clear-btn="true" placeholder="">
      
	  <input type="hidden" name="invite_ename" id="invite_ename" value="<?php echo $user_check?>" data-clear-btn="true" placeholder="Enter friend to invite...">
	  
	   <input type="hidden" name="attendance" id="attendance" value="<?php echo $attendance?>"  data-clear-btn="true" placeholder="Enter friend to invite...">
